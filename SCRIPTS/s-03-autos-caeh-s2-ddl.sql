...
(
  ...
  CONSTRAINT SUCURSAL_PAIS_ID_FK FOREIGN KEY (PAIS_ID)
...
(
  ...
  CONSTRAINT AUTO_SUCURSAL_ID_FK FOREIGN KEY (SUCURSAL_ID)
...
(
  ...
  CONSTRAINT AUTO_CARGA_AUTO_ID_FK FOREIGN KEY (AUTO_ID)
...
(
  ...
  CONSTRAINT AUTO_PARTICULAR_AUTO_ID_FK FOREIGN KEY (AUTO_ID)
  REFERENCES AUTO_F3_CAEH_S2(AUTO_ID)
);
...
(
  ...
  CONSTRAINT PAGO_AUTO_F1_CAEH_S2_PK PRIMARY KEY (CLIENTE_ID, AUTO_ID), 
    CONSTRAINT PAGO_CLIENTE_ID_FK FOREIGN KEY (CLIENTE_ID)
    REFERENCES CLIENTE_F1_CAEH_S2(CLIENTE_ID),
  CONSTRAINT RefAUTO_F3_CAEH_S213 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F3_CAEH_S2(AUTO_ID)
);
...
(
  ...
  TIPO           CHAR(1)          NOT NULL,
  CONSTRAINT TARJETA_CLIENTE_F2_CAEH_S2 PRIMARY KEY (CLIENTE_ID),
