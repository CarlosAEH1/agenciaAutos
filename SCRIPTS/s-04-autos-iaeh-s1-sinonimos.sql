...
--SUCURSAL
create or replace synonym SUCURSAL_F1 for SUCURSAL_F1_IAEH_S1;
...
for HISTORICO_STATUS_F2_IAEH_S1;
--CLIENTE
create or replace synonym CLIENTE_F1 for CLIENTE_F1_CAEH_S2@caehbdd_s2;
create or replace synonym CLIENTE_F2 for CLIENTE_F2_IAEH_S1;
...
create or replace synonym PAGO_AUTO_F2 for PAGO_AUTO_F2_IAEH_S1;
create or replace synonym PAGO_AUTO_F3 for PAGO_AUTO_F3_IAEH_S2@iaehbdd_s2;
--TARJETA_CLIENTE
create or replace synonym TARJETA_CLIENTE_F1 for TARJETA_CLIENTE_F1_IAEH_S1;
...
create or replace synonym MARCA_R3 for MARCA_R_IAEH_S1;
...
create or replace synonym MODELO_R3 for MODELO_R_IAEH_S1;
